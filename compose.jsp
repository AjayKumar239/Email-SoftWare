        ...
        <form name="f1" action="insertMails.jsp">
            <table align=center width=65% border=0>
                ...
                <tr>
                    ...
                    <td><input type=text class="myTextBox" name=mto id=mto></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><textarea name="mtext" id="mtext" border=1 width=100 class="myTextBox"></textarea></td>
                </tr>
                <tr>
                    <td></td>
                    <td><br><br><br><br><input type=submit value="SendMail"
                            class="myButton">&nbsp;&nbsp;&nbsp;&nbsp;<input type=reset value="Reset"
                            class="myButton">&nbsp;&nbsp;&nbsp;&nbsp;<input type=button value="Back" class="myButton">
                    </td>
                </tr>
            </table>
        </form>
